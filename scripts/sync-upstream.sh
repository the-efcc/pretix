...
#
# Policy: efcc follows upstream *release tags*, not upstream's master tip.
# Pass the release tag to sync to:
#
...
echo "If this merge changed package-lock.json, update npmDepsHash in nix/package.nix."
