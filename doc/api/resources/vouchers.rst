...
valid_if_pending                      boolean                    If set to ``true``, orders placed with this voucher are treated like paid orders for most purposes (such as check-in) even before they are paid, and they are not expired automatically.
