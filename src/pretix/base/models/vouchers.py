...
class Voucher(LoggedModel):
    ...
    :type tag: str
    :param valid_if_pending: If set to true, orders placed with this voucher are treated like paid orders for most
                             purposes, even before they are paid.
    ...
    * If you select an item that has variations but do not select a variation, you cannot set block_quota
    ...
    valid_if_pending = models.BooleanField(
        verbose_name=_("Confirm orders regardless of payment"),
        help_text=_("If you check this box, orders placed with this voucher will behave like a paid order for most "
                    ...
                    "some plugins. Such orders will also not be marked as \"expired\" automatically when the payment "
